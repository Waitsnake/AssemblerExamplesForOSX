...
;
; compile with:
; nasm -g -f macho32 GLandJulia.asm
; xcrun gcc -framework GLUT -framework OpenGL -m32 -o GLandJulia.out GLandJulia.o
;
...
;simulation defines
%define it_tief	            30h			;Fraktalparameter
%define xrand		        0fffe0000h
%define yrand		        0fffe0000h
%define seite		        000040000h
%define z_i_anf	            0ffff0000h		;Animationsparameter
%define z_i_end	            000010000h
%define anistep	            800h
%define increase_intensety  5
...
;other variables
window_name:    db "GL and Julia", 10, 0
window_handle:  dd 0
screen_height:  dd 0
screen_width:   dd 0
fullscreen:     dd 0
...
fine: 
        add	    [z_i],dword anistep
        cmp	    [z_i],dword z_i_end
        jl	    no_reset

        ;reset animation parameter
        mov	    [z_i],dword z_i_anf
